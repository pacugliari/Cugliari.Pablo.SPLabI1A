 ...
 * \return LinkedList* linkedlist nuevo con los elementos que pasan el filtrado o NULL
 *
 */
LinkedList* ll_filter(LinkedList* this,int (*pFunc)(void*));

/** \brief  crea una nueva LinkedList con los resultados de la llamada a la función(pFunc) indicada aplicados a cada uno de sus elementos.
 *
 * \param void* puntero a la funcion
 * \return LinkedList* linkedlist nuevo con los elementos que se le aplico la funcion o NULL
 *
 */
